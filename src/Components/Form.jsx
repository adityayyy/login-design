...
const form = () => {
  return (
    <div className=' bg-white px-10 py-20 rounded-3xl border-2 border-gray-200'>
      ...
      <p className='font-medium text-xl text-gray-500 mt-4'>welcome back please enter your details </p>
    <div className='mt-8'>
      <div>
    ...
    <div>
      ...
      <div className='mt-8 flex flex-col gap-y-4'>
          ...
          <button className='flex py-3 boder-2 border-gray-100 items-center justify-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all'>
